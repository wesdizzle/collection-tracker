...
// ../.wrangler/tmp/bundle-OTCPoe/checked-fetch.js
...
var onRequest5 = /* @__PURE__ */ __name(async (context) => {
  try {
    ...
    query += ` ORDER BY p.brand ASC, p.launch_date ASC, g.platform ASC, COALESCE(g.series, g.title) ASC, g.release_date ASC, g.sort_index ASC`;
...
// ../.wrangler/tmp/pages-dXgTQy/functionsRoutes-0.25187684442144853.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-OTCPoe/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-OTCPoe/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.03307862456047572.mjs.map
